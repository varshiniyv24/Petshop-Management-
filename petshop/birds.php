...
body {
  ...
  background-image:url('p1.jpg');background-repeat:repeat-x;background-position:350px 260px;background-color:rgba(44, 130, 201, 1);
...
border: 3px solid #3333ff;background-color:blue;color:white;font-size:17px;" type="submit" value="delete">
</form>
</div>
</body>
</html>
